...
export class StructuredDataService {
  ...
  async handle(requestDto: StructuredDataDto) {
    ...
    const tools = this.componentsRegistryService.getComponentsByType('tool');
    const utilities =
      this.componentsRegistryService.getComponentsByType('utility');
    ...
    const task: ITask = {
      ...
      components: [...tools, ...utilities], // TODO clean this up to dynamically pull utilities used in tools
    };
