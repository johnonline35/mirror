...
const configs = {
  staging: {
    functionName: 'PuppeteerApiStaging-AnyCatchallHTTPLambda-EJUtt6mngdvz',
    bucketName: 'puppeteer-api-cfn-deployments-bb467',
  },
  production: {
    functionName: 'PuppeteerApi-Production',
    bucketName: 'puppeteerapiproduction-staticbucket-whgsylwahslp',
  },
};
...
const run = async () => {
  ...
  try {
    ...
    console.log('updatedEnvVars:', updatedEnvVars);
    ...
    console.log('updateFunctionCommand', updateFunctionCommand);
